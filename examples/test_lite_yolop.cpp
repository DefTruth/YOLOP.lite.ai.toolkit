...
static void test_onnxruntime()
{
  ...
  std::string onnx_path = "..//hub/onnx/cv/yolop-640-640.onnx";
  std::string test_img_path = "../resources/1.jpg";
  std::string save_det_path = "../logs/1_det_onnx.jpg";
  std::string save_da_path = "../logs/1_da_onnx.jpg";
  std::string save_ll_path = "../logs/1_ll_onnx.jpg";
  std::string save_merge_path = "../logs/1_merge_onnx.jpg";

  auto *yolop = new lite::onnxruntime::cv::detection::YOLOP(onnx_path, 16); // 16 threads
